...
import { ContactFancy } from "@/components/contact-fancy";

export const metadata: Metadata = {
  title: "Talk to the founders — OUTFT.",
  description: "OUTFT is early. Reach the founders directly — they read everything.",
};
    ...
    <main className="relative min-h-[100svh] overflow-hidden pt-[64px] text-ink">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1500px] gap-16 px-6 py-20 md:grid-cols-[1fr_1fr] md:gap-24 md:px-10 md:py-28">
        ...
        <div className="md:sticky md:top-28 md:self-start">
          ...
          <blockquote className="mt-12 border-t border-[#bdb8af] pt-6">
            <p className="font-serif text-[clamp(1.3rem,2.4vw,1.8rem)] font-light italic leading-snug">
              &ldquo;The most shareable self-portrait in fashion is a number.&rdquo;
            </p>
            <span className="lbl mt-4 block">Sahana &amp; Victoria — founders</span>
          </blockquote>
        </div>
